<template>
            ...
            <swiper
              ...
              <swiper-slide v-for="(testimonial, index) in testimonials" :key="index">
                <div class="bg-gray-100 dark:bg-gray-800 p-8 rounded-lg text-center">
                  ...
                  <p class="text-gray-600 dark:text-gray-300 text-lg italic mb-6">{{ testimonial.text }}</p>
                  <h4 class="text-gray-800 dark:text-white font-bold">{{ testimonial.name }}</h4>
                  <p class="text-gray-500 dark:text-gray-400">{{ testimonial.position }}</p>
                </div>
              </swiper-slide>
            </swiper>
          </div>
  ...
  const testimonials = [
    {
      name: 'Aziz Karimov',
      position: 'Software Engineer at IT Park',
      text: 'This teacher completely changed my career path. The knowledge and mentorship I received were invaluable.',
      avatar: '/testimonial-1.jpg'
    },
    {
      name: 'Malika Rakhimova',
      position: 'Frontend Developer',
      text: 'The courses are well-structured and the teaching style makes complex concepts easy to understand.',
      avatar: '/testimonial-2.jpg'
    },
    {
      name: 'Timur Aliyev',
      position: 'Student at TUIT',
      text: 'I started with zero knowledge and now I can build my own web applications. Highly recommended!',
